  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center md:items-start px-6 md:px-24 bg-gray-50">
        <h1 className="text-2xl md:text-5xl font-bold text-gray-800 leading-tight mb-4 text-center md:text-left">
          Create a New Account
        </h1>
        <p className="text-gray-600 text-center md:text-left text-lg mb-6 max-w-md">
          Make your account to track expenses and manage finances efficiently.
        </p>
        <img
      ...
      <div className="flex items-center justify-center my-5 md:my-10">
        <div className="bg-white/90 backdrop-blur-lg shadow-2xl rounded-2xl p-8 w-full max-w-md border border-white/20">
          <div className="flex justify-center items-center ">
            ...
            <h1 className="text-xl md:text-2xl font-extrabold text-center bg-gradient-to-r from-indigo-600 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-6">
              Create Your Account
            </h1>
          </div>
