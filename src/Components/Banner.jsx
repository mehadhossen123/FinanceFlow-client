      ...
      >
        ...
        <SwiperSlide>
          <div className="relative">
            <img
              ...
              className="w-full h-[200px]  md:h-[300ppx ] lg:h-[400px] object-cover rounded-lg"
            />

            {/* Dark overlay for better text visibility */}
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start px-10 md:px-24">
              ...
              <button className="mt-6 bg-amber-400 text-blue-800 font-semibold px-6 py-2 rounded-lg hover:bg-amber-500 transition">
                Start Tracking
              </button>
            </div>
          </div>
        ...
        <SwiperSlide>
          <div className="relative">
            ...
            {/* Overlay background for better text visibility */}
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start px-10 md:px-24">
